...
<p><span class="highlight"><?php echo COMPANY; ?></span> ("<span class="highlight"><?php echo NAME; ?></span>", "We", "Us") is a controller of your personal data. We respect your data and your privacy is important to us.</p>

<p>This Privacy Notice explains what personal data we collect and how it is used. This notice also explains what rights you have over your personal data and how you can use those rights.</p>

<p>You have the right to object to some of the processing which <span class="highlight"><?php echo NAME; ?></span> carries out. More information about your rights and how to exercise these is set out in the “Your rights” section of this notice.</p>

<h3>Covid 19 - NHS Track and Trace</h3>

<p>If you are enjoying your coffee whilst sitting in our stores at the moment, we are asking you to register your details with our Track and Trace provider, in accordance with Government guidance. Our provider is a third party called Airship who are processing your data on our behalf and use a cookie which logs your device - specific details can be found in our cookie policy. The details you provide may be shared with the NHS on request. Your details will be retained for the required period of time in line with Government guidance.</p>

<p>An overview of how we use your data is here.</p>

<p><span class="highlight"><?php echo COMPANY; ?></span>’s registered office is <span class="highlight"><?php echo ADDRESS; ?></span>.</p>
<ol>
  <li>Summary of how we use your data and your rights</li>
  <li>Information we collect from you</li>
  <li>Information we receive from third parties</li>
  <li>How we use information and the legal basis</li>
  <li>Data sharing</li>
  ...
  <li>Which Costa entity is the controller?</li>
</ol>
<h2>1. Summary of how we use your data and your rights</h2>

<p>We use your data to provide and improve our products and services, including for marketing, research, feedback and enquiries, and for safety and security purposes. We also use your data when you enter competitions or awards that we organise.</p>

<p>We will use your data to comply with laws and regulations. We use your data to prevent and detect crime, such as fraud.</p>

</p>You have the right to object to some of the processing Costa carries out. More information about your rights and how to exercise these is set out in the “Your rights” section of this notice.</p>

<p>When you give consent, you are able to withdraw that consent at any time, for instance by emailing mycostadata@costacoffee.com. You can also email mycostadata@costacoffee.com to exercise any other data rights, such as obtaining a copy of your data, correcting, deleting or restricting how we use your data. Please see “Your rights” for more information.</p>

<p>You can unsubscribe from marketing communications at any time. To opt out of direct marketing, including profiling for direct marketing purposes, you can either adjust the preference settings in your Costa Club account, or select “unsubscribe” in emails, or email <span class="highlight"><?php echo EMAIL; ?></span>.</p>

<p>Our websites and app use cookies and similar technologies to improve functionality, recognise you and to customise your experience. You can reject and block cookies in your browser settings. Please see our Cookie Notice for more information.</p>

<p>If you enable location services on the app, or you access the location finder on our sites and your browser settings allow this, your device will identify and alert you to the nearest Costa Store and Costa Express to your location.</p>

<p><span class="highlight"><?php echo NAME; ?></span> is part of the Coca Cola group of companies, for details of how personal data is shared with the Coca Cola group, please see the “Data Sharing” section below.</p>

<h>2. Information we collect from you</h2>

<p>We collect information when you purchase something or use our services or enter our competitions or awards. This includes store visits, using our websites or app, joining our Costa Coffee Club, or corresponding with us.</p>
...
In particular:
    ...
    When you sign up to in-store WiFi and give your Costa Coffee Club number to gain access we and the WiFi provider check this number and keep a record of this.
...
To run and promote our business, we use your information:
    ...
    To provide and improve our products and services, including in-store Wifi, Costa Coffee Club and Costa eGift, and to respond to you if you contact us.
    ...
    To administer and run our organised awards, including the Costa Book Awards, and to promote the awards through the publishing of winners' details.
...
To prevent, investigate and/or report fraud, terrorism, misrepresentation, security incidents or crime, including where we are required to do so by law, we:
    ...
    Monitor Costa Coffee Club accounts and Gift card and eGift usage and review CCTV, record call centre communications and emails.
...
When you give consent, you are able to withdraw that consent at any time by contacting us, for instance by emailing mycostadata@costacoffee.com. If you do so we can only continue to use your data if another legal basis applies, such as when we’re required to do something by law.

Nevertheless, you have an absolute right to opt-out of direct marketing, including profiling for direct marketing purposes, at any time. You can opt out of marketing by selecting “unsubscribe” in emails or by adjusting the preference settings on your Costa Coffee Club account or by emailing costacoffeeclub@costacoffee.com.
...
For some activities Costa uses third party service providers, for instance O2 provide WiFi in our stores. When these service providers need customer data from you, we share information with them, such as whether a correct Costa Coffee Club member number has been entered to access WiFi.
...
In addition to using the companies as described above, we use third party providers for the following services:
    ...
    Administration of our competitions and awards, for example our work with the Booksellers Association and panel judges on the Costa Book Awards.
...
We keep your data to enable us to fulfil our contract with you or to provide services, whilst you are an active user of our site, app or Costa Coffee Club, to administer and promote our awards and competitions or where required by law or to protect legal rights.
...
We always look to keep your data for the minimum time in line with data protection principles and our processes. For example, we keep:
    ...
    Information on Costa Coffee Club members as follows. If you register but do not collect and/or use any points using your card or app within 12 months, your registration points will expire and we will delete your Costa Coffee Club account information at that point. If you do not collect and/or use points for 2 years, we will delete your Costa Coffee Club account information.
...
To exercise any of your rights or to withdraw consent you can email: mycostadata@costacoffee.com.

To discuss or change your Costa Coffee Club account details, including preference settings, you can log into ‘My Account’ and go to (account details) and Contact Preferences or contact customer services at costacoffeeclub@costacoffee.com.

For any queries relating to data protection, please contact Costa's Data Protection Officer by email at costadpo@costacoffee.com or write to them at Data Protection Officer, Costa Limited, Costa House, 6 Porz Avenue, Houghton Hall Business Park, Houghton Regis, Dunstable, Beds, LU5 5YG.
